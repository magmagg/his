<section id="main-content">
    <section class="wrapper">
        ...
        echo form_open(base_url().'Laboratory/insert_laboratoryrequest/');
        ?>
        <section class="panel">
            <header style="font-weight:300" class="panel-heading text-center">
                Laboratory Exam List
            </header>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                ...
                                                <?php
                                                    foreach($labexamtype as $labexam){
                                                        echo "<div class='col-lg-3'>";
                                                        echo "<label class='checkbox-inline'>";
                                                        echo "<input type='checkbox' name='laboratoryexams[]' value='".$labexam['lab_exam_type_id']."'>".$labexam['lab_exam_type_name'];
                                                        echo "</label>";
                                                        echo "</div>";
                                                    }
                                                ?>
