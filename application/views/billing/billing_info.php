            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td id="prof_fee">
                                  <?php
                                    echo $professional_fee;
                                    $overall_amount += $professional_fee;
                                  ?>
                              </td>
                    ...
                    <div class="text-center invoice-btn">
                        <?php
                          if($bill_status == 0){
                           echo '<a onclick="input_pf_modal()" class="btn btn-success btn-lg"><i class="fa fa-address-card" aria-hidden="true"></i> Input Professional Fee</a>';
                           echo '<button type="submit" class="btn btn-danger btn-lg"><i class="fa fa-check"></i> Submit Billing </button>';
                          }
                        ?>
                    </div>
                    <?=form_close()?>
