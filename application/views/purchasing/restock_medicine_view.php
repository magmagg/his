            ...
            <section class="panel">
              ...
              <header class="panel-heading">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <?php if($t['status'] == 1):?>
                              <td><button class="btn btn-success btn" data-href="<?php echo base_url();?>Purchasing/release_restock_request/<?php echo $t['unique_id']?>" data-toggle="modal" data-target="#confirm-release">Release</button>
                                  <a href="<?php echo base_url();?>Purchasing/view_one_restock_request/<?php echo $t['unique_id']?>" class="btn btn-danger">View</a>
                              </td>
                              <?php else: ?>
                              <td><a href="<?php echo base_url();?>Purchasing/view_one_restock_request/<?php echo $t['unique_id']?>" class="btn btn-danger">View</a></td>
                              <?php endif;?>
