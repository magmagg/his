                ...
                <section class="panel">
                    ...
                    <?php foreach($details as $d): ?>
                        <?php if($d->phar_stat == 0 && $count == 0): ?>
                            <center>
                                <button class="btn btn-success btn" data-href="<?php echo base_url();?>Purchasing/accept_restock_request/<?php echo $id?>" data-toggle="modal" data-target="#confirm-accept"><i class="fa fa-check"></i></button>
                                <button class="btn btn-danger btn" data-href="<?php echo base_url();?>Purchasing/reject_restock_request/<?php echo $id?>" data-toggle="modal" data-target="#confirm-reject"><i class="fa fa-ban"></i></button>
                            </center>
                        <?php $count++; ?>
                        <?php else: ?>
                        <?php if($count == 0):?>
