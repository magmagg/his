      ...
      <div class="col-sm-3">
        <section class="panel">
  			  <div class="panel-body">
    				<center>
      				<a href="<?=base_url()?>Purchasing/CSRRequests" data-toggle="modal" role="button" class="btn btn-sm btn-round btn-success"><i class="fa fa-eye"></i> All CSR  Requests</a><br><br>
      ...
      <div class="col-sm-9">
        <section class="panel">
          <header class="panel-heading">
            <b>Pending CSR request</b><span class="tools pull-right"></span>
          </header>
  			  <div class="panel-body">
            <div class="adv-table">
