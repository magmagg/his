              ...
              <table class="table table-striped" style="text-align: center;" id="dynamic-table">
                ...
                <?php
                  foreach($rooms as $room){
                    echo "<tr>";
                      echo "<td>".$room['er_id']."</td>";
                      echo "<td>".$room['room_location']."</td>";
                      echo "<td>".$room['price']."</td>";
                      echo "<td>";
                        echo "<a href='".base_url()."Rooms/ViewEmergencyRoom/".$room['er_id']."' role='button' class='btn btn-info btn-sm'>View</a>";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <?php
                        ...
                        echo form_open('Rooms/insert_emergency_room', $attributes);
                      ?>
