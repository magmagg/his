        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <center>
                        <button class="btn btn-success btn" data-href="<?php echo base_url();?>Pharmacy/drug_accept_pharmacy_request/<?php echo $id?>" data-toggle="modal" data-target="#confirm-accept"><i class="fa fa-check"></i></button>
                        <button class="btn btn-danger btn" data-href="<?php echo base_url();?>Pharmacy/drug_reject_pharmacy_request/<?php echo $id?>" data-toggle="modal" data-target="#confirm-reject"><i class="fa fa-ban"></i></button>
                    </center>
