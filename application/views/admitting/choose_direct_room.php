      ...
      <section class="panel">
          <header class="panel-heading">
              ...
              <span class="pull-right">
                  <a href="<?php echo base_url();?>Admitting/DirectRoomAdmission"><button type="button" id="loading-btn" class="btn btn-warning btn-xs"><i class="fa fa-refresh"></i> Refresh</button></a>
              </span>
          </header>
                ...
                <?php
                  foreach($rooms as $room){
                    echo "<tr>";
                      ...
                      echo "<td><a href='".base_url()."Admitting/ChooseBed/".$room['room_id']."' role='button' class='btn btn-info btn-xs'>SELECT ROOM</a></td>";
                    echo "</tr>";
                  }
                ?>
              </tbody>
