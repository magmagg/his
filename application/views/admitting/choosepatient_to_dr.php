        ...
        <section class="panel">
            ...
            <table class="table">
              ...
              <?php
                ...
                echo form_open(base_url().'Admitting/admit_patient_to_dr/'.$bed_id.'/'.$roomid, $attributes);
              ?>
      ...
      <div class="col-sm-6">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                  <div class="col-lg-12">
                    <input type="submit" name="submit" id="submit" value="Submit" class="btn btn-info" disabled>
